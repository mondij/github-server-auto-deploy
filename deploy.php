 ...
 *
 * @version 1.3.1
 * @link    https://github.com/mondij/github-server-auto-deploy/
 */
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'https://github.com/mondij/github-server-auto-deploy.git');
